...
// https://oi000186152-eu1.iam.3dexperience.3ds.com/login?lt=LT-2561637-sMy2023m31LoNOgDBdDg1uO1DZru3B&username=3dxserviceuser@emerson.com&password=Emerson123&service=https://oi000186152-us1-sourcing.3dexperience.3ds.com/enovia/resources/v1/application/CSRF?tenant=OI000186152
...
const authConfig = {
  ...
  CSRFURL:
    "https://oi000186152-us1-sourcing.3dexperience.3ds.com/enovia/resources/v1/application/CSRF?tenant=OI000186152",
  AuthParamURL:
...
export const authenticateUser2 = async (req, res, next) => {
  try {
    ...
    req.authDataQualify = headersForFutureRequests;
